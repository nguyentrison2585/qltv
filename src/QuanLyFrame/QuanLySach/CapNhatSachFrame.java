...
public class CapNhatSachFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thay đổi thông tin sách");
    ...
    public Sach getSach() {
        ...
        if(id.equals("")||ten_sach.equals("")||the_loai.equals("")||tac_gia.equals("")||nha_xuat_ban.equals("")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhatSachFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapNhatSachFrame().setVisible(true);
            }
        });
    }
