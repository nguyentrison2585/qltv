 ...
 * @author Admin
 */
public class QuanLyMainFrame extends javax.swing.JFrame {

    /**
     * Creates new form QuanLyMainFrame
     */
    public QuanLyFrame qlFrame = new QuanLyFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyMainFrame().setVisible(true);
            }
        });
    }
