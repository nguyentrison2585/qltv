...
public class CapNhatBDFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thay đổi thông tin bạn đọc");
    ...
    public BanDoc getBD() {
        ...
        String ho_ten = jTextField2.getText().trim();
        String gioi_tinh = (String)jComboBox1.getSelectedItem();
        String ngay_sinh = jTextField3.getText().trim();
        String dia_chi = jTextField4.getText().trim();
        String so_dt = jTextField5.getText().trim();
        if(id.equals("")||ho_ten.equals("")||ngay_sinh.equals("")||dia_chi.equals("")
                ||so_dt.equals("")) {
            JOptionPane.showMessageDialog(null, "Bạn cần nhập đầy đủ thông tin!",
                    "Warning",JOptionPane.WARNING_MESSAGE);
            return null;
        }
        else if (con.checkMaSach(id)==true) {
            JOptionPane.showMessageDialog(null, "Mã bạn đọc đã tồn tại",
                    "Warning",JOptionPane.WARNING_MESSAGE);
            return null;
        }
        BanDoc bd = new BanDoc(id,ho_ten,gioi_tinh,ngay_sinh,dia_chi,so_dt);
        return bd;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhatBDFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapNhatBDFrame().setVisible(true);
            }
        });
    }
